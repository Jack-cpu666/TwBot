...
# THE KEY CHANGE: Import the undetected_chromedriver
...
# Use eventlet as the async provider
import eventlet
...
def handle_start_browser(data):
    ...
    try:
        ...
        # --- KEY CHANGES FOR UNDETECTED BROWSER ---
        options = uc.ChromeOptions()
        options.add_argument("--no-sandbox")
        options.add_argument("--disable-dev-shm-usage")
        options.add_argument(f"--window-size={width},{height}")
        
        # This tells Chrome to use the Google Chrome binary installed by our Dockerfile
        # It's crucial for running in a custom Linux environment.
